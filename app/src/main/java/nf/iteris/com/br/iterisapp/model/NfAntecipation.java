...
public class NfAntecipation {
    public NfAntecipation() {}

    public NfAntecipation(String number, String description, String dateBilling, String datePayment, String status) {
        this.number = number;
